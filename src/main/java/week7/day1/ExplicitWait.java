...
public class ExplicitWait {
	public static void main(String[] args) throws IOException {
		...
		WebElement findElement3 = driver.findElement(By.xpath("(//span[text()='Click'])[2]"));
		findElement3.click();
		WebElement findElement4 = driver.findElement(By.xpath("//span[text()='I am about to hide']"));
		Boolean until = wait.until(ExpectedConditions.invisibilityOf(findElement4));
